...
public class MyPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayoutManager mLayoutManager = new LinearLayoutManager(MyPost.this);
...
lists.clear();
    ...
    class background extends Thread {
        ...
        public void run() {
            ...
            DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("User_Post").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
...
lists.clear();
                    ...
                    adapter = new PostAdapter(MyPost.this, lists);
